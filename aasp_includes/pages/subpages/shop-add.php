...
<?php $page = new page; ?>
<div class="box_right_title"><?php echo $page->titleLink(); ?> &raquo; A&ntilde;adir Art&iacute;culos</div>
<table width="100%">
        <tr valign="top">
             <td style="text-align: left; width: 300px;"><h3>Un Solo Art&iacute;culo</h3>
             <p/>Entry<br/>
             ...
             <input type="submit" value="Añdir" onclick="addSingleItem()"/>
             </td>
             <td style="text-align: left; width: 300px;"><h3>Varios Art&iacute;culos</h3>
             <p/>
             Niveles entre<br/>
             ...
             <input type="submit" value="Añadir" onclick="addMultiItem()"/>
             </td>
        </tr>
</table>