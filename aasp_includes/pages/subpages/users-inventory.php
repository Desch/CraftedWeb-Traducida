...
<div class="box_right_title"><?php echo $page->titleLink(); ?> &raquo; Inventario de Personajes</div>
Viendo inventario del personaje 
...
Filtrar:
	   <a href="?p=users&s=inventory&guid=<?php echo $_GET['guid']; ?>&rid=<?php echo $_GET['rid']; ?>&f=equip">
		<?php if(isset($_GET['f']) && $_GET['f']=='equip') echo '<b>'; ?>Items Equipados</a><?php if(isset($_GET['f']) && $_GET['f']=='equip') echo '</b>'; ?> 
    &nbsp; | 
&nbsp; <a href="?p=users&s=inventory&guid=<?php echo $_GET['guid']; ?>&rid=<?php echo $_GET['rid']; ?>&f=bank">
		<?php if(isset($_GET['f']) && $_GET['f']=='bank') echo '<b>'; ?>Items en el Banco<?php if(isset($_GET['f']) && $_GET['f']=='bank') echo '</b>'; ?></a> 
    &nbsp; | 
&nbsp; <a href="?p=users&s=inventory&guid=<?php echo $_GET['guid']; ?>&rid=<?php echo $_GET['rid']; ?>&f=keyring">
		<?php if(isset($_GET['f']) && $_GET['f']=='keyring') echo '<b>'; ?>Items en la Bolsa<?php if(isset($_GET['f']) && $_GET['f']=='keyring') echo '</b>'; ?>
        </a> 
     &nbsp; | 
&nbsp; <a href="?p=users&s=inventory&guid=<?php echo $_GET['guid']; ?>&rid=<?php echo $_GET['rid']; ?>&f=currency">
		<?php if(isset($_GET['f']) && $_GET['f']=='currency') echo '<b>'; ?>Monedas<?php if(isset($_GET['f']) && $_GET['f']=='currency') echo '</b>'; ?></a> 
     &nbsp; | 
&nbsp; <a href="?p=users&s=inventory&guid=<?php echo $_GET['guid']; ?>&rid=<?php echo $_GET['rid']; ?>">
		<?php if(!isset($_GET['f'])) echo '<b>'; ?>Todos los Items<?php if(!isset($_GET['f'])) echo '</b>'; ?></a> 
<p/>
<?php
